...
const QUICK_PROMPTS: Record<string, string[]> = {
  "en-IN": [
    ...
    "Divide ₹2,100 Zomato lunch 4 ways",
    "₹1,200 Uber with Arjun, I pay 60%",
  ],
  "hi-IN": [
    "Rahul aur Priya ke saath ₹840 ka Swiggy barabar baanto",
    "₹2,100 ka Zomato lunch 4 logo mein baanto",
    "Arjun ke saath ₹1,200 ka Uber, main 60% dunga",
  ],
  "mr-IN": [
    "Rahul ani Priya sobat ₹840 cha Swiggy samaan vaata",
...
const WELCOME: Record<string, string> = {
  ...
  "hi-IN": "नमस्ते! 👋 माइक दबाएं और बोलें — मैं बिल बांट दूंगा और UPI लिंक भेजूंगा।",
  "mr-IN": "नमस्कार! 👋 माइक दाबा आणि बोला — मी बिल वाटून UPI लिंक्स पाठवेन।",
  "ta-IN": "வணக்கம்! 👋 மைக்கை தட்டி பேசுங்கள் — பில்லை பிரித்து UPI லிங்க் தருகிறேன்.",
  "te-IN": "నమస్కారం! 👋 మైక్ నొక్కి మాట్లాడండి — బిల్ విభజించి UPI లింక్ ఇస్తాను.",
  "bn-IN": "নমস্কার! 👋 মাইক ট্যাপ করুন এবং বলুন — বিল ভাগ করে UPI লিঙ্ক পাঠাবো।",
};

const PLACEHOLDERS: Record<string, string> = {
  "en-IN": "Type here or tap the mic to speak…",
  "hi-IN": "यहाँ टाइप करें या माइक दबाकर बोलें…",
  "mr-IN": "इथे टाइप करा किंवा माइक दाबा…",
  "ta-IN": "இங்கே தட்டச்சு செய்யுங்கள் அல்லது மைக் தட்டுங்கள்…",
  "te-IN": "ఇక్కడ టైప్ చేయండి లేదా మైక్ నొక్కండి…",
  "bn-IN": "এখানে টাইপ করুন বা মাইক ট্যাপ করুন…",
};
...
export default function SplitPage() {
  ...
  useEffect(() => {
    setMessages([{
      id: "welcome",
      role: "assistant",
      content: WELCOME[language.code] || WELCOME["en-IN"],
    }]);
  }, [language.code]);
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Speak or type · AI splits + sends UPI links</p>
            </div>
          </div>
              ...
              {msg.splitData && (
                <div className="mt-2 bg-white border border-indigo-100 shadow-sm rounded-2xl p-4 space-y-3">
                  ...
                  <div className="bg-indigo-50 rounded-xl p-2.5 text-xs text-indigo-700 text-center">
                    📱 Tap copy icon → share UPI link on WhatsApp
                  </div>
                </div>
              )}
            </div>
      ...
      <div className="shrink-0 px-4 pt-2 pb-5">
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            disabled={loading}
            className="flex-1 px-4 py-3 bg-white border border-gray-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 disabled:opacity-50"
          />
        ...
        <p className="text-center text-[11px] text-gray-400 mt-2">
          🎙️ Tap mic → speak in <strong>{language.nativeLabel}</strong> → tap again to send &nbsp;·&nbsp; AI replies in <strong>{language.nativeLabel}</strong>
        </p>
      </div>
    </div>
  );
